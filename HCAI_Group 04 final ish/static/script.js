document.addEventListener("DOMContentLoaded", function () {
    ...
    fileInput.addEventListener("change", async function () {
        ...
        try {
            ...
            localStorage.setItem("most_likely_prob_low", data.most_likely_prob_low);
            localStorage.setItem("most_likely_prob_high", data.most_likely_prob_high);
            localStorage.setItem("second_most_prob_low", data.second_most_prob_low);
            localStorage.setItem("second_most_prob_high", data.second_most_prob_high);
            localStorage.setItem("third_most_prob_low", data.third_most_prob_low);
            localStorage.setItem("third_most_prob_high", data.third_most_prob_high);
